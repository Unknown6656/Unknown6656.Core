///////////////////////////////////////////////////////////////////////
//             AUTOGENERATED 2021-01-06 17:26:25.393637              //
...
namespace Unknown6656.Imaging
{
    ...
    public partial struct HDRColor
    {
        ...
        public (double Hue, double Saturation, double Luminosity) HSL
        {
            ...
            readonly get => ToHSL();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (R, G, B) = FromHSL(value.Hue, value.Saturation, value.Luminosity);
        }
        ...
        public (double Hue, double Saturation, double Value) HSV
        {
            ...
            readonly get => ToHSV();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (R, G, B) = FromHSV(value.Hue, value.Saturation, value.Value);
        }
        ...
        public (double C, double M, double Y, double K) CMYK
        {
            ...
            readonly get => ToCMYK();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (R, G, B) = FromCMYK(value.C, value.M, value.Y, value.K);
        }
        ...
        public (double Y, double U, double V) YUV
        {
            ...
            readonly get => ToYUV();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (R, G, B) = FromYUV(value.Y, value.U, value.V);
        }
        ...
        public readonly double GetIntensity(Wavelength wavelength, double tolerance = 1e-1)
        {
            ...
            double dist_mid = ((HDRColor)wavelength).CIALAB94DistanceTo(this);

            if (tolerance < Scalar.ComputationalEpsilon)
                return dist_mid;

            double dist_lo = ((HDRColor)lo).CIALAB94DistanceTo(this);
            double dist_hi = ((HDRColor)hi).CIALAB94DistanceTo(this);
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HDRColor FromConsoleColor(ConsoleColor color, ConsoleColorScheme color_scheme) => _console_colors[(int)color_scheme][color];
    ...
    public partial struct RGBAColor
    {
        ...
        public (double Hue, double Saturation, double Luminosity) HSL
        {
            ...
            readonly get => ToHSL();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (Rf, Gf, Bf) = FromHSL(value.Hue, value.Saturation, value.Luminosity);
        }
        ...
        public (double Hue, double Saturation, double Value) HSV
        {
            ...
            readonly get => ToHSV();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (Rf, Gf, Bf) = FromHSV(value.Hue, value.Saturation, value.Value);
        }
        ...
        public (double C, double M, double Y, double K) CMYK
        {
            ...
            readonly get => ToCMYK();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (Rf, Gf, Bf) = FromCMYK(value.C, value.M, value.Y, value.K);
        }
        ...
        public (double Y, double U, double V) YUV
        {
            ...
            readonly get => ToYUV();
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => (Rf, Gf, Bf) = FromYUV(value.Y, value.U, value.V);
        }
        ...
        {
            (Wavelength lo, Wavelength hi) = (wavelength.InNanometers + tolerance, wavelength.InNanometers - tolerance);
            double dist_mid = ((RGBAColor)wavelength).CIALAB94DistanceTo(this);

            if (tolerance < Scalar.ComputationalEpsilon)
                return dist_mid;

            double dist_lo = ((RGBAColor)lo).CIALAB94DistanceTo(this);
            double dist_hi = ((RGBAColor)hi).CIALAB94DistanceTo(this);
