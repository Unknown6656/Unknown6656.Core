...
///////////////////////////////////////////////////////////////////////
//             AUTOGENERATED 2022-04-18 21:28:48.493962              //
    ...
    : ImplicitFunction<Vector2>
{
    ...
    public ImplicitScalarFunction2D(Func<Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1]), comparison, v => right(v[0], v[1]))
    {
    }
    ...
    public ImplicitScalarFunction2D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction2D Shift(Vector2 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction2D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction2D LinearInterpolate(ImplicitScalarFunction2D first, ImplicitScalarFunction2D second, Scalar factor)
    {
    ...
    : ImplicitFunction<Vector3>
{
    ...
    public ImplicitScalarFunction3D(Func<Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2]), comparison, v => right(v[0], v[1], v[2]))
    {
    }
    ...
    public ImplicitScalarFunction3D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction3D Shift(Vector3 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction3D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction3D LinearInterpolate(ImplicitScalarFunction3D first, ImplicitScalarFunction3D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector4>
{
    ...
    public ImplicitScalarFunction4D(Func<Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3]), comparison, v => right(v[0], v[1], v[2], v[3]))
    {
    }
    ...
    public ImplicitScalarFunction4D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction4D Shift(Vector4 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction4D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction4D LinearInterpolate(ImplicitScalarFunction4D first, ImplicitScalarFunction4D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector5>
{
    ...
    public ImplicitScalarFunction5D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4]), comparison, v => right(v[0], v[1], v[2], v[3], v[4]))
    {
    }
    ...
    public ImplicitScalarFunction5D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction5D Shift(Vector5 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction5D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction5D LinearInterpolate(ImplicitScalarFunction5D first, ImplicitScalarFunction5D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector6>
{
    ...
    public ImplicitScalarFunction6D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4], v[5]), comparison, v => right(v[0], v[1], v[2], v[3], v[4], v[5]))
    {
    }
    ...
    public ImplicitScalarFunction6D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction6D Shift(Vector6 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction6D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction6D LinearInterpolate(ImplicitScalarFunction6D first, ImplicitScalarFunction6D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector7>
{
    ...
    public ImplicitScalarFunction7D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4], v[5], v[6]), comparison, v => right(v[0], v[1], v[2], v[3], v[4], v[5], v[6]))
    {
    }
    ...
    public ImplicitScalarFunction7D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction7D Shift(Vector7 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction7D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction7D LinearInterpolate(ImplicitScalarFunction7D first, ImplicitScalarFunction7D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector8>
{
    ...
    public ImplicitScalarFunction8D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7]), comparison, v => right(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7]))
    {
    }
    ...
    public ImplicitScalarFunction8D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction8D Shift(Vector8 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction8D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction8D LinearInterpolate(ImplicitScalarFunction8D first, ImplicitScalarFunction8D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector9>
{
    ...
    public ImplicitScalarFunction9D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7], v[8]), comparison, v => right(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7], v[8]))
    {
    }
    ...
    public ImplicitScalarFunction9D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction9D Shift(Vector9 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction9D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction9D LinearInterpolate(ImplicitScalarFunction9D first, ImplicitScalarFunction9D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
    ...
    : ImplicitFunction<Vector10>
{
    ...
    public ImplicitScalarFunction10D(Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> left, ComparisonOperator comparison, Func<Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar, Scalar> right)
        : base(v => left(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7], v[8], v[9]), comparison, v => right(v[0], v[1], v[2], v[3], v[4], v[5], v[6], v[7], v[8], v[9]))
    {
    }
    ...
    public ImplicitScalarFunction10D Negate() => new(v => Left.Evaluate(-v), ComparisonOperator, v => Right.Evaluate(-v));

    public ImplicitScalarFunction10D Shift(Vector10 offset) => new(v => Left.Evaluate(v - offset), ComparisonOperator, v => Right.Evaluate(v - offset));

    public ImplicitScalarFunction10D Scale(Scalar factor) => new(v => Left.Evaluate(v / factor), ComparisonOperator, v => Right.Evaluate(v - factor));

    public static ImplicitScalarFunction10D LinearInterpolate(ImplicitScalarFunction10D first, ImplicitScalarFunction10D second, Scalar factor)
    {
        ComparisonOperator op = ComparisonOperator.EqualTo;
