...
/// </summary>
/// <remarks>
/// The <see cref="Quaternion"/> structure is used to efficiently rotate an object about the (x,y,z) vector by the angle theta, where:
/// <c>w = cos(theta/2)</c>
/// </remarks>
...
public unsafe readonly /* ref */ partial struct Quaternion
    ...
    , ICloneable
#if GENERIC_MATH
    , IIncrementOperators<Quaternion>
    , IModulusOperators<Quaternion, Scalar, Quaternion>
    , IMultiplyOperators<Quaternion, Quaternion, Scalar>
    , IMultiplyOperators<Quaternion, Scalar, Quaternion>
    , IDivisionOperators<Quaternion, Scalar, Quaternion>
    , IMultiplyOperators<Scalar, Quaternion, Quaternion>
    , IDecrementOperators<Quaternion>
    ...
    , IComparisonOperators<Quaternion, Quaternion>
    , IEqualityOperators<Quaternion, Quaternion>
#endif
{
    private readonly Vector4 _coeff;
    ...
    public Quaternion(Quaternion pointer)
        : this(pointer._coeff)
    {
    }
    ...
    public Quaternion(Vector4* pointer)
    {
    }

    public Quaternion(Scalar* pointer)
    {
    }
